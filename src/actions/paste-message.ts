...
export class PasteMessageAction extends SingletonAction {
  constructor(manifestId: string) {
    super(manifestId);
  }

  override async onKeyDown(ev: KeyDownEvent): Promise<void> {
    console.log("[AutoDeck] ▶️ spawning:", PYTHON, SCRIPT, "msg");

    const proc = spawn(PYTHON, [SCRIPT, "msg"], { cwd: "H:/AutoDeck" });
